...
-- 5. WORK ITEMS (Creative Assets / Content Units)
...
-- 6. ASSET VERSIONS (v1, v2, v3... revision tree)
...
-- 7. REVIEW REMARKS (Frame.io style timestamped corrections & remarks)
...
-- 8. HANDOVER AUDIT LOGS (Traceability when teammates leave/rebalance)
